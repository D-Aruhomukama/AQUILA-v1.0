...
st.write("""
# blaTEM Gene Prediction

blaTEM is 1 of 3 commonest ABR genes, that confers resistance to Cephems/3rd-Generation 
Cephalosporins particularly Ceftriaxone and Ceftazidime.
""")

# Load the prediction model
svc = joblib.load("tem_svc.pkl")
...
if fasta_file:
    ...
    for idx, row in df_results.iterrows():
        ...
        if label_map[row['Prediction']] == "Resistant":
            conclusion_text = (
                'Conclusion: The isolate may be resistant to Cephems/3rd-Generation Cephalosporins, particularly Ceftriaxone and Ceftazidime. Report Immediately to the Healthcare Provider. Perform additional testing for AmpC and Carbapenemase Production to assess broader beta-lactam resistance. '
            )

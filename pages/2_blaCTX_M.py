...
# Load model
svc = joblib.load("ctxm_Lmodel.pkl")
...
st.write("""
# blaCTX-M Gene Prediction

blaCTX-M is 1 of 3 commonest ABR genes, that confers resistance to Cephems/3rd-Generation 
Cephalosporins particularly Cefotaxime, and sometimes Ceftazidime.
""")
...
if fasta_file:
    ...
    for idx, row in df_results.iterrows():
        ...
        if label_map[row['Prediction']] == "Resistant":
            conclusion_text = ("Conclusion: The isolate may be resistant to Cephems/3rd-Generation Cephalosporins, particularly Cefotaxime, and sometimes Ceftazidime. Report Immediately to Healthcare Provider. Perform additional testing for AmpC and Carbapenemase Production to assess broader beta-lactam resistance."
            )
...
if st.button("Predict Single Sequence"):
    if len(sequence_input.strip()) == 0:
        ...
        if prediction == "Resistant":
            conclusion_text = (
            "Conclusion: The isolate may be resistant to Cephems/3rd-Generation Cephalosporins, particularly Cefotaxime, and sometimes Ceftazidime. Report Immediately to Healthcare Provider. Perform additional testing for AmpC and Carbapenemase Production to assess broader beta-lactam resistance."
            )
